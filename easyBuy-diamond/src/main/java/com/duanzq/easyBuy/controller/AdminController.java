...
import com.duanzq.easyBuy.domain.DiamondStone;
import com.duanzq.easyBuy.domain.Page;
import com.google.common.base.CharMatcher;
import com.google.common.base.Charsets;
import com.google.common.base.Throwables;
import org.apache.commons.lang3.StringUtils;
import com.duanzq.easyBuy.service.AdminService;
import com.duanzq.easyBuy.service.DiamondService;
import com.duanzq.easyBuy.service.PersistService;
import com.duanzq.easyBuy.utils.Constants;
import com.duanzq.easyBuy.utils.Encrypt;
import com.duanzq.easyBuy.utils.Json;
import com.duanzq.easyBuy.utils.GlobalCounter;
    ...
    public String batchQuery(HttpServletRequest request, HttpServletResponse response,
        ...
        for (String dataId : dataIdArray) {
            ...
            try {
                ...
                log.error("Batch query error on dataId={}, group={}", dataId, group);
                e.printStackTrace();
    ...
    public String batchAddOrUpdate(HttpServletRequest request, HttpServletResponse response,
        ...
        for (String dataIdAndContent : dataIdAndContentArray) {
            ...
            try {
                ...
                log.error("Batch Update error on dataId={},group={}", dataId, group + ",content=" + content);
                e.printStackTrace();
                configInfoEx.setStatus(Constants.BATCH_OP_ERROR);
