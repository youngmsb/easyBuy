...
import static com.duanzq.easyBuy.utils.Constants.*;
...
public class DiskService {
    ...
    public void updateToDisk(DiamondStone diamondStone) throws IOException {
        ...
        try {
            ...
            log.error("save disk error, dataId={},group={}", dataId, group);
