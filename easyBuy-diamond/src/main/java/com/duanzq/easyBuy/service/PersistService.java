...
import com.duanzq.easyBuy.domain.PageHelper;
import com.duanzq.easyBuy.utils.Props;
...
public class PersistService {
    ...
    private DataSource createDataSource(Properties props) {
        ...
        tableName = getPropStr(props, "db.tableName", "tb_diamond_stones");
    ...
    private Properties readJdbcProperties() throws IOException {
        return Props.tryProperties("conf/diamond-jdbc.properties", ".diamond-server");
    }
