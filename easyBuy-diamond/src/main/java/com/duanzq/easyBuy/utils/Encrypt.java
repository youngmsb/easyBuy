package com.duanzq.easyBuy.utils;

import com.duanzq.easyBuy.security.Pbe;
...
public class Encrypt {
    ...
    public static String encryptValueWithKey(String origin, String key) {
        return "{PBE}" + Str.purifyBase64(Pbe.encrypt(origin, key));
    }
    ...
    public static String tryDecrypt(String original, String dataId) {
        ...
        if ("PBE".equalsIgnoreCase(algrithm)) {
            return Pbe.decrypt(Str.paddingBase64(encrypted), dataId);
        }
