...
!function() {
    ...
    a.fn.Jlazyload = function(b, c) {
        if (this.length) {
            var d, e, f = a.extend({type: null,offsetParent: null,source: "data-lazyload",placeholderImage: "/easyBuy-portal/images/blank.gif",placeholderClass: "loading-style2",threshold: 200}, b || {}), g = this, h = function(a) {
...
var category = {OBJ: $("#_JD_ALLSORT"),
		URL_Serv: "http://localhost:8988/easyBuy-rest/item/cat/list?callback=category.getDataService",
       ...
       /* var a, b = {}, c = $("#categorys-2013");
        ...
        //因为返回的数据被category.getDataService包住, 会直接执行, 因此可以不声明回调方法
