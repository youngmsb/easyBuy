...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="/easyBuy-portal/css/purchase.base.2012.css" />
   <link rel="stylesheet" type="text/css" href="/easyBuy-portal/css/purchase.sop.css" />
   <title>订单成功页面 - 淘淘商城</title>
   <script type="text/javascript" src="/easyBuy-portal/js/jquery-1.2.6.min.js"></script>
   <script type="text/javascript" src="/easyBuy-portal/js/base-2011.js" charset="utf-8"></script>
   <script type="text/javascript" src="/easyBuy-portal/js/jquery.cookie.js" charset="utf-8"></script>
...
<div class="w" id="headers">
		<div id="logo"><a href="http://www.jd.com/"><img alt="淘淘商城" src="/easyBuy-portal/images/taotao-logo.gif"></a></div>
